#chaincode insall
docker exec cli peer chaincode install -n mym -v 2.0 -p github.com/mymarbles
...
docker exec cli peer chaincode invoke -o orderer.example.com:7050 -n mym -c '{"Args":["initMarble"]}'  --transient "{\"marble\":\"$MARBLE\"}"
sleep 5
