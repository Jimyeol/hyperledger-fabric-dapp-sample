...
app.get('/api/querycar/', function (req, res) {
    fs.readFile('./application/querycar.html', function (error, data) {
        res.send(data.toString());
    });
});
...
app.get('/api/querycar/:id', async function (req, res) {
                // create the key value store as defined in the fabric-client/config/default.json 'key-value-store' setting
    try {

    var carno = req.params.id;
	console.log(carno);
